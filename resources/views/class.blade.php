...
<!--
function Redirect(){
   if(document.getElementById('criteria').value=="class"){
     window.location="statementinterface.html";
      }
   if(document.getElementById('criteria').value=="subject"){
     window.location="subject.html";
      }
     else{
	      window.location="reffile.html";
	     }
 }
-->
</script>
...
<div id="masthead">
  ...
  <!-- end globalNav -->
  <div id="subglobal1" class="subglobalNav"> <a href="reffile.html">subglobal1 link</a> | <a href="#">subglobal1 link</a> | <a href="#">subglobal1 link</a> | <a href="#">subglobal1 link</a> | <a href="#">subglobal1 link</a> | <a href="#">subglobal1 link</a> | <a href="#">subglobal1 link</a> </div>
...
<form  name="myFormAssess"> 
    <label for="criteria">Choose Class:</label>
    <select id="criteria" name="criteria">
      <option>Class</option><option>1A1</option>
      <option>1A2</option><option>2A1</option>
      <option>2A2</option><option>3A1</option>
      <option>3A2</option><option>4A1</option>
      <option>4A2</option>
      
      </select>
	<input type="button" value="Submit" onclick="Redirect()"/></td>
	     </form> 
	 </p>
  </div>
  <!--end content -->
  <div id="siteInfo">&copy;2016 Tress College </div>
</div>
<!--end pagecell1-->
<br />
<script type="text/javascript">
